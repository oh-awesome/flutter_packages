...
void registerPigeonProxyApiHandlers() {
  final pigeonInstanceManager = PigeonInternalInstanceManager.instance;
...
Future<void> main() async {
  ...
  // PigeonInternalInstanceManager._initInstance() fires native clear() without awaiting; wait
