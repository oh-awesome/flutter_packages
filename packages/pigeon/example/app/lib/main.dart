...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _sendFloat64List() async {
    final result = await _hostApi.sendFloat64List(
      Float64List.fromList([12.3, 45.6, 78.9]),
    );
  ...
  Future<void> _sendMap() async {
    final result = await _hostApi.sendMap({
      'Name': 'zhangsan',
      'Country': 'China',
    });
  ...
  Future<void> _sendCustomClass() async {
    final student = await _hostApi.sendCustomClass(
  ...
  Future<void> _triggerPlatformEchoNullableEnum() async {
    try {
      final r1 = await _hostApi.triggerPlatformEchoNullableEnum(
        Identity.student,
      );
