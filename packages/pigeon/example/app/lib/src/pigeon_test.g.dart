...
class PigeonInternalInstanceManager {
  ...
  PigeonInternalInstanceManager({required void Function(int) onWeakReferenceRemoved}) {
  ...
  static PigeonInternalInstanceManager _initInstance() {
    ...
    api.clear();
    final PigeonInternalInstanceManager instanceManager = PigeonInternalInstanceManager(
...
class _PigeonInternalInstanceManagerApi {
  ...
  }) {
    {
      final BasicMessageChannel<
          Object?> pigeonVar_channel = BasicMessageChannel<
              Object?>(
          'dev.flutter.pigeon.pigeon_example_app.PigeonInternalInstanceManagerApi.removeStrongReference',
          pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (pigeon_clearHandlers) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.pigeon_example_app.PigeonInternalInstanceManagerApi.removeStrongReference was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.pigeon_example_app.PigeonInternalInstanceManagerApi.removeStrongReference was null, expected non-null int.');
          try {
  ...
  Future<void> clear() async {
    const String pigeonVar_channelName =
        'dev.flutter.pigeon.pigeon_example_app.PigeonInternalInstanceManagerApi.clear';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
...
class HostEnumCounter extends PigeonInternalProxyApiBaseClass {
  ...
  Future<int> increment(int by) async {
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[this, by]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
