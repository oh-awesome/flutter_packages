...
dependencies:
  pigeon:
    git:
      ...
      ref: "br_pigeon-v26.1.5_ohos_dev"
...
This project is licensed under [BSD-3-Clause](https://gitcode.com/CPF-Flutter/flutter_packages/blob/br_pigeon-v26.1.5_ohos_dev/packages/pigeon/LICENSE).
