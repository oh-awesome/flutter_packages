...
This project is based on [pigeon@21.2.0](https://pub.dev/packages/pigeon/versions/21.2.0) 
...
1. Flutter version 3.22.4-ohos-1.1.3; SDK: 6.1.1.125 (API Version 24 Release); IDE: DevEco Studio: 6.1.1.290; ROM: 6.1.0.117 SP6;
...
This project is licensed under [BSD-3-Clause](https://gitcode.com/CPF-Flutter/flutter_packages/blob/pigeon-v21.2.0_dev/packages/pigeon/LICENSE).
