...
This project is licensed under [BSD 3-Clause License](https://gitcode.com/CPF-Flutter/flutter_packages/blob/br_local_auth-v2.3.0_ohos/packages/local_auth/local_auth_ohos/LICENSE), feel free to use and contribute.
