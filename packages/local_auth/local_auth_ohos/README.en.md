...
dependencies:
  local_auth:
    git:
      ...
      # ref: local_auth-v3.0.0-ohos-1.0.0
...
1. Flutter: 3.35.7-ohos-0.0.1-canary1; SDK: 5.0.0(12); IDE: DevEco Studio: 5.0.13.200; ROM: 5.1.0.120 SP3;
...
This project is licensed under [BSD 3-Clause License](https://gitcode.com/CPF-Flutter/flutter_packages/blob/br_local_auth-v3.0.0_ohos/packages/local_auth/local_auth_ohos/LICENSE), feel free to use and contribute.
