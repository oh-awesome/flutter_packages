...
dependencies:
  local_auth:
    git:
      ...
      # ref: local_auth-v2.1.6-ohos-1.0.1
...
本项目基于 [BSD 3-Clause License](https://gitcode.com/CPF-Flutter/flutter_packages/blob/master/packages/local_auth/local_auth_ohos/LICENSE)，请自由地享受和参与开源。
