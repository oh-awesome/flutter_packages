...
void main() {
  ...
  const SharedPreferencesAsyncOhosOptions emptyOptions =
      SharedPreferencesAsyncOhosOptions();

  SharedPreferencesAsyncOhos getPreferences() {
    final _FakeSharedPreferencesApi api = _FakeSharedPreferencesApi();
    final SharedPreferencesAsyncOhos preferences =
        SharedPreferencesAsyncOhos(api: api);

    return preferences;
  }

  test('set and get String', () async {
    final SharedPreferencesAsyncOhos preferences = getPreferences();
