...
void main() {
  ...
  group('SharedPreferencesOhos', () {
    ...
    testWidgets(
      ...
      (WidgetTester _) async {
        ...
        await (preferences as SharedPreferencesOhos).api
  ...
  void runAsyncTests(bool useDataStore) {
    group('shared_preferences_async', () {
      ...
      testWidgets('set and get String with $backend', (WidgetTester _) async {
        final SharedPreferencesAsyncOhosOptions options = getOptions(
      ...
      testWidgets(
        ...
        (WidgetTester _) async {
          ...
          final preferences = getPreferences() as SharedPreferencesAsyncOhos;
          await clearPreferences(preferences, options);
  ...
  testWidgets('Shared Preferences works with multiple files', (
    ...
    final SharedPreferencesAsyncOhosOptions options1 = getOptions(
      useDataStore: false,
      fileName: 'file1',
    );
    final SharedPreferencesAsyncOhosOptions options2 = getOptions(
      useDataStore: false,
      fileName: 'file2',
    );
    final SharedPreferencesAsyncPlatform preferences = getPreferences();
