...
void main() {
  ...
  group('SharedPreferencesOhos', () {
    ...
    testWidgets(
      ...
      await preferences.setValue('Int', 'Int', allTestValues['Int']!);
      await preferences.setValue('Double', 'Double', allTestValues['Double']!);
      await (preferences as SharedPreferencesOhos)
          .api
  ...
  SharedPreferencesAsyncOhosOptions getOptions({
    required bool useDataStore,
    String? fileName,
  }) {
    return SharedPreferencesAsyncOhosOptions(
      backend: useDataStore
          ? SharedPreferencesOhosBackendLibrary.DataStore
          : SharedPreferencesOhosBackendLibrary.SharedPreferences,
  ...
  Future<void> clearPreferences(
    ...
    SharedPreferencesAsyncOhosOptions options,
  ) async {
    await preferences.clear(
  ...
  void runAsyncTests(bool useDataStore) {
    group('shared_preferences_async', () {
      ...
      testWidgets('getStringList throws type error for String with $backend',
        ...
        // Internally, List<String> is stored as a String on Ohos, but that
      ...
      testWidgets(
        ...
        final SharedPreferencesAsyncOhosOptions options =
            getOptions(useDataStore: useDataStore, fileName: 'notDefault');
        final SharedPreferencesAsyncOhos preferences =
            getPreferences() as SharedPreferencesAsyncOhos;
        await clearPreferences(preferences, options);
  ...
  testWidgets('Shared Preferences works with multiple files',
      (WidgetTester _) async {
    final SharedPreferencesAsyncOhosOptions options1 =
        getOptions(useDataStore: false, fileName: 'file1');
    final SharedPreferencesAsyncOhosOptions options2 =
