...
This project is based on [webview_flutter@4.6.0](https://pub.dev/packages/webview_flutter/versions/4.6.0).
...
For use cases [ohos/example](https://gitcode.com/openharmony-tpc/flutter_packages/tree/br_3.7.12-ohos-1.1.1/packages/webview_flutter/webview_flutter_ohos/example/lib/main.dart)
...
This project is licensed under  [BSD-3-Clause](https://gitcode.com/openharmony-tpc/flutter_packages/blob/master/packages/webview_flutter/webview_flutter/LICENSE) .
