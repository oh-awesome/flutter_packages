...
dependencies:
  webview_flutter:
    git:
      ...
      # ref: webview_flutter-v4.4.2-ohos-1.0.0
...
This project is licensed under  [BSD-3-Clause](https://gitcode.com/CPF-Flutter/flutter_packages/blob/master/packages/webview_flutter/webview_flutter/LICENSE) .
