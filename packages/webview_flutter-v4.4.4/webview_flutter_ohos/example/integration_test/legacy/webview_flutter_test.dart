...
Future<void> main() async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      ohos_webview.WebView.api = WebViewHostApiImpl(
        instanceManager: instanceManager,
      );
      ohos_webview.WebSettings.api = WebSettingsHostApiImpl(
        instanceManager: instanceManager,
      );
      ohos_webview.WebChromeClient.api = WebChromeClientHostApiImpl(
        instanceManager: instanceManager,
      );
      ohos_webview.WebViewClient.api = WebViewClientHostApiImpl(
        instanceManager: instanceManager,
      );
      ohos_webview.DownloadListener.api = DownloadListenerHostApiImpl(
        instanceManager: instanceManager,
      );
      ...
      ohos_webview.WebStorage.instance = ohos_webview.WebStorage();
    },
    skip: true,
  );
