...
This project is based on [flutter_plugin_android_lifecycle](https://pub.dev/packages/flutter_plugin_android_lifecycle) .
...
For detailed use cases, please see [example](example/lib/main.dart).
