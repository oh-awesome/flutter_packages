...
class _AudioTracksDemoState extends State<AudioTracksDemo> {
  ...
  Future<void> _initializeVideo() async {
    ...
    try {
      ...
      _isAudioTrackSupported = controller.isAudioTrackSupportAvailable();
  ...
  Future<void> _loadAudioTracks() async {
    ...
    if (!controller.isAudioTrackSupportAvailable()) {
      ...
      setState(() {
        _audioTracks = <VideoAudioTrack>[];
        _error = 'Audio track API is not supported on this platform.';
      });
      return;
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          Padding(
            ...
            child: Row(
              children: <Widget>[
                const Text('isAudioTrackSupportAvailable: '),
                Text(
                  _isAudioTrackSupported ? 'true' : 'false',
                  style: TextStyle(
                    color: _isAudioTrackSupported ? Colors.green : Colors.red,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: _isAudioTrackSupported ? _loadAudioTracks : null,
