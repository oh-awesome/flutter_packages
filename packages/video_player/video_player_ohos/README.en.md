...
This project is developed based on [video_player@2.10.1](https://pub.dev/packages/video_player/versions/2.10.1).
...
dependencies:
  video_player:
    git:
      ...
      # ref: video_player-v2.10.1-ohos-1.0.0
...
| :--- | :--- | :--- |
| 3.35 | `-` | `br_video_player-v2.10.1_ohos` |
