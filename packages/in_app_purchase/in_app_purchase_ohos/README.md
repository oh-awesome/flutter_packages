...
dependencies:
  in_app_purchase:
    git:
      ...
      ref: br_in_app_purchase-v3.2.0_ohos
```
...
> Version reference rule: this repository maintains the adaptation on OHOS branches that correspond to upstream versions. Prefer actual published branches or tags, for example br_in_app_purchase-v3.2.0_ohos.
