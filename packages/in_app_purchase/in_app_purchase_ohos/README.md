...
> Version reference rule: this repository maintains the adaptation on OHOS branches that correspond to upstream versions. Prefer actual published branches or tags, for example br_in_app_purchase-v3.2.3_ohos.
...
1. Flutter: 3.35.8-ohos-0.0.3; SDK: 5.0.2(14); IDE: DevEco Studio: 6.1.2.268; ROM: 6.1.0.117;
2. Flutter: 3.41.10-ohos-0.0.1; SDK: 5.0.2(14); IDE: DevEco Studio: 6.1.1.268; ROM: 6.1.0.117;
