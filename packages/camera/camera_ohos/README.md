...
| ImageFormatGroup.jpeg     | 32-big RGB image encoded into JPEG bytes.                    | enum | yes          |
...
| streamOptions  | onfiguration options for streaming.        | CameraImageStreamOptions?        | yes          |
...
This project is licensed under [The MIT License (MIT)](https://gitcode.com/openharmony-tpc/flutter_packages/blob/br_camera-v0.11.3_ohos/packages/camera/camera_ohos/LICENSE).
