...
dependencies:
  camera_ohos:
    git:
      ...
      # ref: camera-v0.10.5_5-ohos-1.0.1
...
本项目基于 [The MIT License (MIT)](https://gitcode.com/CPF-Flutter/flutter_packages/blob/master/packages/camera/camera_ohos/LICENSE) ，请自由地享受和参与开源。
