...
void main() {
  ...
  group('Function Tests', () {
    ...
    test('Should prepare for video recording', () async {
      // prepareForVideoRecording is a no-op on OHOS, so no hostApi call
      // is made. We just verify the method completes without error.
    ...
    test(
      'Should pass maxVideoDuration when starting recording a video',
      () async {
        // Arrange
        // Act
    ...
    test('Should stop a video recording and return the file', () async {
      ...
      // Act
      // OHOS requires startVideoRecording to be called before stopVideoRecording
      // due to the _isRecordingMap check.
      await camera.startVideoRecording(cameraId);
